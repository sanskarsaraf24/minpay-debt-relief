...
export const ProblemSection = () => {
  return <section className="py-16 md:py-24 bg-gradient-to-b from-secondary to-background">
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-12 mb-12">
            {problems.map((problem, index) => <div key={index} className="flex items-start gap-4 p-6 bg-card rounded-xl shadow-sm border border-border hover:shadow-md transition-shadow">
          ...
          <div className="bg-accent/10 border border-accent/30 rounded-lg p-6 inline-block">
            <p className="text-lg font-semibold text-foreground">
              You're not alone.{" "}
              <span className="text-accent">5000+ people</span> have already found relief with MinPay.
            </p>
          </div>
        </div>
      </div>
